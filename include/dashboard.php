  ...
  <div class="row">
    ...
    <div class="span4">
      <div class="widget">
        <div class="widget-header"> <i class="icon-bookmark"></i>
          <h3>Consulte el estado de su equipo</h3>
        </div>
        <div class="widget-content">
          <form action="#" method="post">
            <div class="login-fields">
              <p>Digite el numero de su documento de identidad</p>
              <div class="field">
                <input type="text" id="identificacion" name="identificacion" value="" placeholder="Documento de Identidad" class="login username-field" />
              </div> 
            </div> 
            <div class="login-actions">
              <button class="button btn btn-warning btn-large">Consultar</button>
            </div> 
          </form>         
        </div>
      </div>
    ...
    <div class="span3">
      <div class="widget">
        ...
        <div class="widget-content">
         <div class="fb-like-box" data-href="https://www.facebook.com/flisolflorencia" data-width="255" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
         <div id="fb-root"></div>
       </div>
     </div>
   </div>
